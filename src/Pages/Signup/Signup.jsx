    ...
    <>
      <main className="py-12 bg-gray-50">
        <div className="container grid lg:grid-cols-2 lg:gap-12">
          {/* Left side */}
          <div className="w-80 md:w-full mx-auto space-y-8 py-10">
          ...
          {/* Right side (Form) */}
          <div className="w-80 md:w-full mx-auto px-5 py-10 space-y-8 bg-white rounded-xl shadow-xl">
            <div className="text-center">
              <h2 className="text-xl md:text-2xl lg:text-3xl font-semibold">Create Your Account</h2>
